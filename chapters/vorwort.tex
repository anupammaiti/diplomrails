...
Zusätzlich wird auf Implementierungs und Umsetzungsdetails der Systeme eingegangen, um so auf mögliche Probleme hinzuweisen.
...
\newline
\newline
In Kapitel 3 folgt die Analyse der Leistungsfähigkeit der ausgewählten Ruby on Rails 3 Web Content Management Systeme Alchemy CMS, Browser CMS, Lokomotive CMS und Refinery CMS. Dazu werden die Kriterien des im Kapitel 2 vorgestellten Katalogs mit den tatsächlich gebotenen Funktionalitäten der gewählten WCMS verglichen.
\newline
Kapitel 4 beschreibt konzeptionelle und programmiertechnische Umsetzungsdetails der analysierten WCM-Systeme und zeigt vorhandene Problemstellen heraus.
