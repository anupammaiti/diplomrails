...
\lstinputlisting[label=lst:contentblock, caption=Aufruf des Generator-Skripts zur Erstellung eines neuen Inhaltselements Produkt]{code/content_block.rb}
%Browser END
...
\begin{figure}[!h]
\begin{center}
\includegraphics[scale=0.3]{images/analyse/locomotive/liquid.png}
