...
\item
Das Model bezeichnet in Rails Klassen, die einen Zugriff auf relationale Datenbanken oder andere Datenspeicher ermöglichen \citep{Rails2}
%\citep[vgl.][]{Rails2}
\item
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.3]{images/rack/middlewares.png}
...
Der in der einschlägigen Literatur bereits mehrfach thematisierte Anstieg von Content\footnote{Der Begriff des Content kann mit dem deutschen Wort Inhalt übersetzt werden und bezeichnet im Allgemeinen Informationen ...} erfordert innerhalb der einzelnen Unternehmen ein entsprechend zielgerichtetes Management. Berechtenbreiter definiert den Begriff des Content Management mit folgenden Worten:
\begin{quote}
...
Im Bereich der internet-basierten Web-Sites und Portale hat dies zur Herausbildung des Web Content Managements geführt \citep[][Seite 3]{ecm}. Die dort verwendeten Lösungen
...
\newline
\newline
Die von Ritter formulierten Kriterien werden in den Kapiteln \ref{sec:erstellung} bis \ref{sec:archi} nochmals aufgeführt und bilden die Grundlage für die Bewertung der Leistungsfähigkeit der ausgewählten Ruby on Rails Content Management Systeme.
